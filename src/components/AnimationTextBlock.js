        ...
        >
          ...
          {videoSrcUrl !== "" &&
            <div className="reizeQuickActionVideo">
              <video name="media_resize" id="resize_Quick_Action_Id" loop className="resizeQuickActionViedo" type="video/mp4" preload="auto" autoplay muted playsinline autobuffer >
